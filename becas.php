...
<section id="section-construccion-futuro">
    <div class="container section-construccion-futuro px-0">
        <div class="row mb-3">
            <div class="col-12 text-center">
                <h2 class="construccion-futuro-titulo">
                    Ayudamos a construir tu futuro
                </h2>
            </div>
        </div>
        <div class="row">
            <div class="col-4">
                <div class="p-4 d-flex flex-column justify-content-between box-construccion-futuro">
                    <div class="construccion-futuro-testimonio mb-5">
                        <p>
                            Muy prácticas sus materias y de alto nivel. Gracias a ello pude obtener una plaza muy solicitada.
                        </p>
                    </div>
